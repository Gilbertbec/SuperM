namespace SuperM.Business.Services
{
	...
	public class DepartmentService
	{
		...
		//{
		//	var departments = _context.Departments.Select(x => new { x.DepartmentId, x.Name, CompanyName = x.Company.Name }).ToList();
		//	return departments;
		//}
		...
		//public dynamic GetDepartmentListByName(string name)
		//{
		//	var departments = _context.Departments.Where(x => x.Name.Contains(name)).Select(x => new { x.DepartmentId, x.Name, CompanyName = x.Company.Name }).ToList();
		//	return departments;
		//}
